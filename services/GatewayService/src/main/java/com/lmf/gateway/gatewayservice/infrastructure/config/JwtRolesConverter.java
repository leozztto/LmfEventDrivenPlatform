...
/**
 * Converte o claim {@code roles} do JWT emitido pelo AuthService (lista de strings já com o prefixo
 * {@code ROLE_}) em authorities do Spring Security, usadas nas regras {@code hasRole(...)} das rotas.
 */
