package com.lmf.inventory.inventoryservice.infrastructure.kafka.config;
 ...
 * tentativas, envio da mensagem para a DLT (nunca retentativa infinita).
 */
@Slf4j
@Configuration
public class KafkaErrorConfig {
    ...
    public DefaultErrorHandler kafkaErrorHandler(KafkaTemplate<String, String> kafkaTemplate) {
        ...
        DeadLetterPublishingRecoverer recoverer = new DeadLetterPublishingRecoverer(kafkaTemplate, (record, exception) -> {
            ...
            return new TopicPartition(KafkaTopics.INVENTORY_RESERVATION_DLT, record.partition());
        });
