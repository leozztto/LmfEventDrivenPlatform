...
import com.lmf.notification.notificationservice.infrastructure.kafka.consumer.PaymentFailedConsumer;
...
class PaymentFailedConsumerTest {
    ...
    private NotifyPaymentFailedUseCase useCase;
    ...
    void setUp() {
        ...
        useCase = mock(NotifyPaymentFailedUseCase.class);
        consumer = new PaymentFailedConsumer(inboxService, useCase);
    }
